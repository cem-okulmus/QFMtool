...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9eea0d6b32e59d2b2d158afc00cbb712) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Cem Okulmus <me@myhost.com>"];
          homepage = None;
          bugreports = None;
          synopsis =
            "A tool to test and visualise various methods to implement quantifier fuzzification methods (QFM for short)";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lablgtk2.rsvg", None)
                        ];
     ...
     oasis_digest = Some "\185t\212\152\t_c[\177\2025H!\249\130-";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
